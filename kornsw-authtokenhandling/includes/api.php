...
function kornsw_authtokenhandling_try_get_access_token($token_source_uid,$options=array()){return KornSW_ATH_Token_Manager::try_get_access_token($token_source_uid,0,$options);}
function kornsw_authtokenhandling_require_access_token($token_source_uid,$options=array()){return KornSW_ATH_Token_Manager::require_access_token($token_source_uid,$options);}
function kornsw_authtokenhandling_authorized_request($token_source_uid,$url,$options=array()){return KornSW_ATH_Token_Manager::authorized_request($token_source_uid,$url,$options);}
