...
final class KornSW_ATH_Plugin {
    ...
    public function boot(){KornSW_ATH_Config_Repository::migrate_legacy_primary_source();KornSW_ATH_Admin::register_hooks();KornSW_ATH_OAuth_Flow::register_hooks();KornSW_ATH_Session_Guard::register_hooks();KornSW_ATH_Shortcodes::register_hooks();}
}
